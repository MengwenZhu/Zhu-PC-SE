function Data_Summary = runEngram_Cell_Analysis(Inscopix1, Inscopix2, Noldus1, Noldus2, Start_T1, Start_T2, PlaceCell_Summary1, PlaceCell_Summary2, dateToFind, animalName, drug, session1_dose, session2_dose, session1_context, session2_context, genotype, exptParadigm, ds, ap)
% runEngram_Cell_Analysis - calls Engram_Cell_Analysis_V1 and appends fields

Data_Summary = Engram_Cell_Analysis_V1(Inscopix1, Inscopix2, Noldus1, Noldus2, Start_T1, Start_T2, PlaceCell_Summary1, PlaceCell_Summary2, ds, ap);
